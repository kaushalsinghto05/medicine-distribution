...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 text-white border-b border-slate-800">
      ...
      {/* Micro-dot grid mesh for authentic SaaS/Marketplace texture */}
      <div 
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8 pb-12 sm:pt-12 sm:pb-16">
        {/* Top Trust & CDSCO Wholesale Verification Badges (Retailio & Kunal Pharma style) */}
        <div className="flex flex-wrap items-center gap-2 sm:gap-2.5 mb-6">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-900/90 border border-slate-700/80 text-teal-400 text-xs font-semibold shadow-xs">
            ...
            <span>CDSCO Form 20B/21B Wholesale Compliant</span>
          </div>
          ...
          <div className="hidden md:inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-slate-900/80 border border-slate-800 text-slate-300 text-xs font-medium">
            ...
            <span>100% GST E-Way Bill & B2B Tax Invoiced</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-center">
          ...
          <div className="lg:col-span-7 space-y-5">
            ...
            {/* High-Contrast Retailio/Biddano Style Live Search Box */}
            <div className="pt-1">
              <form onSubmit={handleSearchSubmit} className="relative flex items-center shadow-2xl">
                ...
                <button
                  type="submit"
                  className="px-5 sm:px-7 py-3.5 bg-gradient-to-r from-teal-600 to-indigo-600 hover:from-teal-500 hover:to-indigo-500 text-white font-bold text-xs sm:text-sm rounded-r-2xl transition-all flex items-center gap-1.5 shadow-lg shadow-teal-600/20 shrink-0"
                >
                  <span>Search</span>
              ...
              {/* Trending Molecules / Generic Composition Chips (Retailio & Medimny signature) */}
            ...
            {/* Live Operational Metrics Ribbon (Biddano & Retailio style) */}
          ...
          {/* Right Column: Live Hub Dispatch Terminal & Multi-Tenant Isolation Switcher */}
            ...
            <div className="bg-gradient-to-b from-slate-900 to-slate-950 rounded-3xl p-5 sm:p-6 border border-slate-800 shadow-2xl space-y-4">
              ...
              <div className="flex items-center justify-between pb-3 border-b border-slate-800">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <span className="text-xs font-bold text-white block">Regional Distribution Depot</span>
              ...
              {/* Hub Selector (Biddano & Orange Biotech UP regional model) */}
              <div className="space-y-1.5">
                ...
                <div className="pt-1 flex items-center justify-between text-[11px] text-slate-400 bg-slate-950/80 px-3 py-1.5 rounded-lg border border-slate-800/80">
                  <span className="flex items-center gap-1.5">
                    <Clock className="w-3.5 h-3.5 text-amber-400" />
                    <span>Next Dispatch Cutoff: <strong className="text-slate-200">{activeHubData.cutoff}</strong></span>
                  </span>
                  <span className="text-emerald-400 font-semibold font-mono">100% In-Stock</span>
                </div>
              </div>
