      ...
      {!isBarVisible ? (
        <div className="max-w-7xl mx-auto px-4 py-1 flex items-center justify-between">
          <button
            ...
            className="flex items-center gap-1.5 text-[11px] font-semibold text-slate-400 hover:text-sky-300 py-0.5"
          >
            <KeyRound className="w-3 h-3 text-indigo-400" />
            <span>Show JWT Auth & Token Inspector</span>
